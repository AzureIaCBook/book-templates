...
module frontend 'appservice.bicep' = {
  name: 'frontend'
  scope: rg1
  dependsOn: [
    peering1
  ...
  params: {
    appName: 'bicepfrontend'
    subnetResourceId: vnet1.outputs.subnetId
    restrictAccess: false
  }
}

module api 'appservice.bicep' = {
  name: 'api'
  scope: rg2
  dependsOn: [
    peering2
  ...
  params: {
    appName: 'bicepapi'
    subnetResourceId: vnet2.outputs.subnetId
    restrictAccess: true
    restrictAccessFromSubnetId: vnet1.outputs.subnetId
  }
}
